...
- **Demo models** — `large-muffin.nam`, `british-800-preamp.nam`, `cali-duo-reverb-85watt.nam`, `dirty-hamster.nam`, `clone-overdrive.nam`, `special-bundle-overdrive-183-rock-channel.nam`, `vinny-iii-drive.nam`, `brit-in-a-box.nam`, `special-bundle-overdrive-183-jazz-channel.nam`, `anxiety-drive.nam`, `green-mids-overdrive.nam`, `american-blonde.nam`, `american-blonde-v2.nam`, `lol-250-overdrive.nam`, for trying the parametric knobs (no model is bundled)
