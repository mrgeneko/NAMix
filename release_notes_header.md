...
- **Demo models** — `large-muffin.nam`, `british-800-preamp.nam`, `cali-duo-reverb-85watt.nam`, `dirty-hamster.nam`, `clone-overdrive.nam`, `special-bundle-overdrive-183-rock-channel.nam`, `vinny-iii-drive.nam`, `brit-in-a-box.nam`, for trying the parametric knobs (no model is bundled)
